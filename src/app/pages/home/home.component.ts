...
export class HomeComponent implements OnInit {
  ...
  retrieveTimezones(): void {
    this.timezonesService
      .getTimezones(this.authService.authenticatedUser()!.id)
      .subscribe((timezones) => {
        this.userTimezones = timezones;
      });
  }

  async addTimezone(): Promise<void> {
    const user = this.authService.authenticatedUser();

    if (this.userTimezones.length < 5) {
  ...
  async deleteTimezone(id: string): Promise<void> {
    await this.timezonesService.deleteTimezone(id);
